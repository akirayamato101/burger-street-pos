/* =============================================
   CASHIER-INVENTORY.JS — 3 of 4 app modules
   Cashier management, shifts, inventory counts,
   deliveries, expenses.
   Continues from products-modals.js — see index.html.
   ============================================= */
...
function renderInventory() {
  ...
  // products-modals.js) precisely so this function can tell the two cases apart —
