/* =============================================
   CORE-POS.JS — 1 of 4 app modules
   Cashier login/session, cart, menu grid, order
   totals, global app state & persistence.
   Load order matters — see index.html:
   core-pos -> products-modals -> cashier-inventory -> reports-pdf
   ============================================= */
