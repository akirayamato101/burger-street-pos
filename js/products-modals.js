/* =============================================
   PRODUCTS-MODALS.JS — 2 of 4 app modules
   Product management, settings, receipts/print,
   toasts, delivery & cash-advance modals.
   Continues from core-pos.js — see index.html.
   ============================================= */
...
function saveDelivery() {
  ...
  if (qtyNum > 0) {
    ...
    // movement was saved. The report (renderInventory in cashier-inventory.js) uses
